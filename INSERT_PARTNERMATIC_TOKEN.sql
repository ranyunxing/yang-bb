-- ========================================
-- 插入 Partnermatic Token 的完整 SQL
-- ========================================

-- 第一步：查询 Partnermatic 联盟的 ID
-- 如果你已经知道 ID，可以跳过这一步
...
-- VALUES (
--     'f8a2a9cd-f556-45cc-bc78-0080dcb3e6d',  -- ⚠️ 替换为 Partnermatic 的 ID
--     'YOUR_ACTUAL_TOKEN_HERE',                 -- ⚠️ 替换为你的真实 token
--     '我的 Partnermatic 账号',                  -- 改成你想显示的名称
--     true
-- );
...
-- 第三步：验证是否插入成功
SELECT * FROM network_accounts_view WHERE network_type = 'partnermatic';
